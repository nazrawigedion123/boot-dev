from main import Card, HighCardRound, LowCardRound
...
def result_to_card(card1: Card, card2: Card, placement: int) -> Card | str:
    if placement == 1:
        return card1
    elif placement == 2:
        return card2
...
def test(
    card1: Card, card2: Card, expected_high_winner: int, expected_low_winner: int
) -> bool:
    try:
        print("---------------------------------")
        print("Inputs:")
